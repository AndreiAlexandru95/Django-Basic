...
class QuestionModelTests(TestCase):
	...
	def test_was_published_recently_with_recent_question(self):
		"""
		was_published_recently() returns True for questions whose pub_date is within the current day.
		"""
...
def create_question(question_text, days):
	...
	(negative for past questions, positive for questions that have yet to be published)
	"""
